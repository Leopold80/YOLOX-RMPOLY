...
def main():
    ...
    # ---------------------------Step 5. Create infer
    # request----------------------------------------------------------- load_network() method of the IECore class
    # with a specified number of requests (default 1) returns an ExecutableNetwork instance which stores infer
    # requests. So you already created Infer requests in the previous step.
