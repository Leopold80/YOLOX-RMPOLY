...
class Exp(MyExp):
    ...
    def get_data_loader(self, batch_size, is_distributed, no_aug=False, cache_img=False):
        ...
        with wait_for_the_master(local_rank):
            ...
            #     cache=cache_img,
            # )
            dataset = RMCODataset(root_path="F:/RMCO/dataset_utils/roco/roco_train",
                                  img_size=(640, 640),
                                  preproc=TrainTransform(
                                      max_labels=50,
                                      flip_prob=self.flip_prob,
    ...
    def get_eval_loader(self, batch_size, is_distributed, testdev=False, legacy=False):
        from yolox.data import RMCODataset, ValTransform

        valdataset = RMCODataset(root_path="F:/RMCO/dataset_utils/roco/roco_val",
                                 img_size=(640, 640),
